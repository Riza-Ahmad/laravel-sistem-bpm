        ...
        <div class="shadow p-5 m-5 mt-3 bg-white rounded">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group mb-3">
                        ...
                        <p>{{ \Carbon\Carbon::parse($peraturan->dok_tgl_berlaku)->locale('id')->translatedFormat('l, d F Y') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group mb-3">
                        ...
                        <p>{{ \Carbon\Carbon::parse($peraturan->dok_tgl_kadaluarsa)->locale('id')->translatedFormat('l, d F Y') }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    ...
                    <p>{{ \Carbon\Carbon::parse($peraturan->dok_created_date)->locale('id')->translatedFormat('l, d F Y') }}
                    </p>
                </div>
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <p>
                        @if ($peraturan->dok_modif_date)
                            {{ \Carbon\Carbon::parse($peraturan->dok_modif_date)->locale('id')->translatedFormat('l, d F Y') }}
                        @else
                            -
                        @endif
                    </p>

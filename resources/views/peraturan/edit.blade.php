...
<div class="d-flex flex-column min-vh-100 p-5 pt-0">
    <div class="ms-5 ps-3">
        <div style="display: flex; align-items: center;">
            <span style="color: #2654A1; font-size: 5rem; margin-right: 10px; cursor: pointer;" onclick="window.location.href='/peraturan/index'">&#x2039;</span>
    ...
    <div class="shadow p-5 m-5 mt-3 bg-white rounded">
        ...
        <form method="POST" action="{{ route('peraturan.update', $peraturan->dok_id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')

             <div class="form-group mb-3">
                <label for="dok_judul" class="form-label fw-bold">Judul Peraturan</label>
                <input type="text" name="dok_judul" id="dok_judul" class="form-control" value="{{ $peraturan->dok_judul}}">
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="dok_nomor_induk" id="dok_nomor_induk" class="form-control" value="{{ $peraturan->dok_nomor_induk}}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group mb-3">
                        <label for="dok_tgl_berlaku" class="form-label fw-bold">Tahun Dokumen</label>
                        <input type="date" name="dok_tgl_berlaku" id="dok_tgl_berlaku" class="form-control" value="{{ $peraturan->dok_tgl_berlaku}}">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="date" name="dok_tgl_kadaluarsa" id="dok_tgl_kadaluarsa" class="form-control" value="{{ $peraturan->dok_tgl_kadaluarsa}}">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group mb-4">
                ...
                <input type="file" name="dok_file" id="dok_file" class="form-control" accept="file/*" value="{{ $peraturan->dok_control}}">
            </div>
